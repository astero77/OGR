...
def create_animation(paths, colors, names, figsize=(12, 12), x_lim=(-2, 2), y_lim=(-1,3), n_seconds=5):
...
if __name__ == "__main__":
    ...
    path_adamOGR = run_optimization(xy_init, AdamOGR, n_iter, lr=2, gamma=0.5)

    freq = 100
    paths = [path_adam[::freq], path_adamOGR[::freq]]
    colors = ["green", "orange"]
    names = ["Adam", "Duda"]

    """
    paths = [path_adamOGR[::freq]]
    colors = ["green"]
    names = ["AdamOGR"]
    """
